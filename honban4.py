...
if st.session_state.page == "home":
    ...
    if st.session_state.start_button_clicked_t1p1:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q9.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q9.csv')
    ...
    if st.session_state.start_button_clicked_t1p2:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q15.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()
        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q15.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t1p3:
        ...
        # DataFrameを表示
        st.markdown(df.style.hide(axis="index").to_html(), unsafe_allow_html=True)
        df_high_preds = pd.read_csv('./preds/low_preds_q25.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q25.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t1p4:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q44.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q44.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t1p5:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q47.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q47.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p1:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q2.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q2.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p2:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q3.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q3.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p3:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q7.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q7.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p4:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q8.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q8.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p5:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q17.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q17.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p6:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q12.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q12.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p7:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q18.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q18.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p8:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q21.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q21.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p9:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q24.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q24.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p10:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q37.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q37.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p11:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q10.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q10.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p12:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q38.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q38.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p13:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q45.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q45.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p14:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q46.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q46.csv')
        df_feature = df_feature.iloc[:-1,0:1]
    ...
    if st.session_state.start_button_clicked_t2p15:
        ...
        df_high_preds = pd.read_csv('./preds/low_preds_q49.csv')
        y_pred = df_high_preds.iloc[:,0:1].values.flatten().tolist()

        # 特徴量のデータフレーム
        df_feature = pd.read_csv('./importance/low_feature_q49.csv')
        df_feature = df_feature.iloc[:-1,0:1]
